<?php
if(isset($_POST['username']) && isset($_POST['user_email']) && isset($_POST['user_password'])&& isset($_POST['phoneNum'])){

// CHECK IF FIELDS ARE NOT EMPTY
    if(!empty(trim($_POST['username'])) && !empty(trim($_POST['user_email'])) && !empty($_POST['user_password'])&& !empty($_POST['phoneNum'])){
...
// Escape special characters.
        ...
        $phone = mysqli_real_escape_string($db_connection, htmlspecialchars($_POST['phoneNum']));
...
// INSERT USER INTO THE DATABASE
                $insert_user = mysqli_query($db_connection, "INSERT INTO `users` (username, user_email, user_password, PhoneNum) VALUES ('$username', '$user_email', '$user_hash_password','$phone' )");
